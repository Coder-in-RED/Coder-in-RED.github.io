...
var ContainsText = ["Beim Fußball spielen werden Sie gefoult und reißen sich die Kreuzbänder","Sie als Taxifahrer laden ein schweres Gepäckstück Ihres Kundes in Ihrem Taxi ein. Dabei verrenken Sie sich die Wirbelsäule.","Sie laden ein schweres Gepäckstück in Ihrem Fahrzeug ein und verrenken sich die Wirbelsäule.","Herr Mustermann entschied sich selbst zu verletzen um mit dem Geld der Unfallversicherung seine Schulden abzuzahlen","Durch einen Zeckenbiss erkrankt Frau Mustermann an Borreliose. der Fall ist…","Durch Trunkenheit am Steuer erlitt Fr. Mustermann einen Unfall. Ihr rechter Arm kann sich nie wieder bewegen.","Der Sohn der Familie Mustermann ist unter 10 Jahren alt und liebt es, mit seiner Mutter Pilze zu sammeln. Leider biss er in einen Fliegenpilz und vergiftete sich dabei.","Durch einen Autounfall wird Hr. Mustermann Querschnittgelähmt. Er war auf dem Weg zum Supermarkt und ist nur Gesetzlich versichert.","Fr. Mustermann eilt die Treppe runter, da sie ihren Arzttermin verpasst. Dabei rutscht sie unglücklicherweise aus. Sie wird ihr Bein nie mehr so gut bewegen können wie jetzt.","Herr Mustermann erlitt einen Autounfall und erlitt kleine Schnittwunden und ein Paar blaue flecken die nach ein Paar Tagen alle verheilten."];
var score = 0;
var start = false;
var RealNumber;
var NewButton;
